...
class RegistrationController: UIViewController {
    ...
    private lazy var usernamContainerView: InputContainerView = {
    ...
    func configureUI() {
        ...
        let stack = UIStackView(arrangedSubviews: [emailContainerView,
                                                   ...
                                                   usernamContainerView,
                                                   passwordContainerView,
                                                   signUpButton])
        stack.axis = .vertical
        stack.spacing = 16
        view.addSubview(stack)
        stack.anchor(top: plusPhotoButton.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 28, paddingLeft: 32, paddingRight: 32)
